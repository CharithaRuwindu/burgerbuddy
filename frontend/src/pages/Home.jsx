...
const Home = () => {
    return (
        <div className="h-[92vh] w-full bg-cover bg-center overflow-auto scrollbar-hide" style={{ backgroundImage: `url(${burgersImage})`,backgroundSize: 'cover', backgroundPosition: 'center', position: 'relative'}}>
            ...
            <div className="h-[92vh] text-stone-100 font-medium z-10">
                <div>Hi</div>
            </div>
            <div className="h-[92vh] bg-white flex justify-center">
                ...
                <div className="m-auto h-[80%] w-[30%]">
                    ...
                    <div className="flex mt-3 justify-center w-[60%] mx-auto">
                        <div className="rounded-full cursor-pointer h-[3rem] w-[3rem] mx-auto border-2 border-yellow-600 flex justify-center items-center text-2xl text-yellow-600"><FaInstagram /></div>
                        <div className="rounded-full cursor-pointer h-[3rem] w-[3rem] mx-auto border-2 border-yellow-600 flex justify-center items-center text-2xl text-yellow-600"><FiFacebook /></div>
                        <div className="rounded-full cursor-pointer h-[3rem] w-[3rem] mx-auto border-2 border-yellow-600 flex justify-center items-center text-2xl text-yellow-600"><FaXTwitter /></div>
                    </div>
